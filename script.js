...
function updateCustomPreview() {
    const source = customRateSource.value; // e.g., JPY
    const target = appData.primaryCurrency; // Clean code e.g., HKD
...
// D. Save Custom Rate Button Logic
...
// E. Fetch Live Rate Button Logic (Stand-alone Logic)
document.getElementById('fetch-live-rate-btn').addEventListener('click', async () => {
    const source = customRateSource.value; 
    const target = appData.primaryCurrency; // FIX: Use clean appData code, not the field with flag

...
function updateAdjustmentsDisplay() {
    ...
    const adjustmentNameInput = document.getElementById('adjustment-name');
    const adjustmentDebtorSelect = document.getElementById('adjustment-debtor');
    const adjustmentCreditorSelect = document.getElementById('adjustment-creditor');
    const addAdjBtn = document.getElementById('add-adjustment-btn');
    ...
    appData.adjustments.forEach((adj, index) => {
        ...
        adjDiv.innerHTML = `
            ...
            <div class="flex gap-1 shrink-0">
                <button class="edit-adjustment-btn bg-sky-100 text-sky-600 rounded-full w-7 h-7 flex items-center justify-center font-bold hover:bg-sky-200 transition-colors" data-index="${index}" aria-label="Edit adjustment">✏️</button>
                <button class="delete-adjustment-btn bg-rose-100 text-rose-600 rounded-full w-7 h-7 flex items-center justify-center font-bold hover:bg-rose-200 transition-colors" data-index="${index}" aria-label="Delete adjustment">✖</button>
            </div>
        `;
